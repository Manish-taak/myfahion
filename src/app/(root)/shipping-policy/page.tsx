...
/**
 * Page component renders the Shipping Policy section with related details.
 * @component
 */
const Page = () => {
  return (
    <>
      <section className="mt-[159px]">
        <div className="py-5 md:py-[30px] bg-extra_bg">
          ...
          <Policytittle title="Shipping Policy" className="md:mt-[60px]" />
        </div>
        {/* Mapping over shippingdata to render PolicySection for each item */}
        {policydata?.shippingdata.map((item, index) => (
