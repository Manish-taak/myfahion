...
/**
 * Page component renders the Return & Refund Policy section with related details.
 * @component
 */
const Page = () => {
  return (
    <>
      <section className="mt-[159px]">
        ...
        {/* Mapping over refunddata to render PolicySection for each item */}
        {policydata?.refunddata.map((item, index) => (
