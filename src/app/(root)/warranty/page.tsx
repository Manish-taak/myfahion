...
/**
 * Page component renders the Warranty section with related details.
 * @component
 */
const Page = () => {
  return (
    <>
      <section className="mt-[159px]">
        ...
        {/* Mapping over warrantydata to render PolicySection for each item */}
        {policydata?.warrantydata.map((item, index) => (
