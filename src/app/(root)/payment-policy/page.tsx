...
/**
 * Page component renders the Payment Policy section with a breadcrumb and policy sections.
 * @component
 */
const Page = () => {
  return (
    <>
      <section className="mt-[159px]">
        <div className="p-3 py-5 md:py-[30px] bg-extra_bg">
          ...
          {/* Policy title component for Payment Policy */}
          <Policytittle title="Payment Policy" className="md:mt-[60px]" />
        </div>

        {/* Mapping through payment policy data and rendering PolicySection components */}
        {policydata?.paymentdata.map((item, index) => (
